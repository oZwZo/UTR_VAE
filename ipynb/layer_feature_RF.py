...
f = open(f'/home/wergillius/Project/UTR_VAE/ipynb/layer_map/NBT_explain/{layer}_k{args.k}_{args.data}_Sep15.log', 'w')
...
human_popen.kfold_cv = False if args.k is None else "train_val" #TODO
